...
class Level11 extends StatefulWidget {
  final String title = "المستوى الحادي عشر";
  final String mission = "ساعدني للحصول على اللون الأخضر";
  ...
  Widget build(BuildContext context) {
    _colorsWidgets = [
      GestureDetector(
        ...
        child: getptionWidget('orange', false),
      ),
      GestureDetector(
        onTap: () => setState(() {
          showStar1 = !showStar1;
        ...
        child: getptionWidget('yellow', showStar1),
      ),
      GestureDetector(
        onTap: () => setState(() {
          _checkResults(false);
