...
class Level06 extends StatefulWidget {
  final String title = "المستوى السادس";
  final String mission = "هيا لنخلط اللونين الذين سينتجو اللون الأزرق الفاتح";

  Level06({Key key}) : super(key: key);

  @override
  _Level06State createState() => _Level06State();
}
                ...
                Flexible(
                    ...
                    child: Center(
                        child: DragTarget<Color>(
                            ...
                            onWillAccept: (data) =>
                                data == Colors.blue || data == Colors.grey[200]
                                    ? true
                                    : false,
                            onAccept: (data) {
                              firstColor = data;
